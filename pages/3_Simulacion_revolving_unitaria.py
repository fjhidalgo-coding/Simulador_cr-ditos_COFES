...
tipo_calculo = col_varios_4.selectbox("Tipo de cálculo",["Seleccionar","Vitesse","Cuota","Duración"])
if tipo_calculo=="Vitesse":
    valor=col_varios_5.selectbox("Vitesse (%)",vitesse_valores)
elif tipo_calculo=="Cuota":
    opciones_cuota=[round(capital*v/100,2) for v in vitesse_valores]
    valor=col_varios_5.selectbox("Cuota mensual (€)",opciones_cuota)
...
seguro_str=col_varios_6.selectbox("Seguro mensual",list(opciones_seguro.keys()))
