...
def simular_masivamente(capital_2sec,
    ...
    errores_simulacion_masiva = tools.pd.DataFrame(errores_simulacion_masiva)
    
    return resultado_simulacion_masiva, errores_simulacion_masiva
